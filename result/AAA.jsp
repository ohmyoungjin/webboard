...
<body>
	<form action="BBB.jsp" method="post"  enctype="multipart/form-data" name="mt">
	     <input type="hidden" name="num" value="7789"> <br>
		 제목: <input type="text" name="title" value="snow"> <br>
		 글쓰기:<div contentEditable="true" id ="good">gdgd
				<p id ="preview"></p>
				</div>
		글읽어오기:<textarea name = "hi" value="Write()">ddd</textarea>
